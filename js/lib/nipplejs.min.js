        ...
        function (t, i, e) {
                ...
                (_.prototype.off = function (t, i) {
                    return (
                        ...
                        void 0 === t
                            ...
                            : this._handlers_[t] && this._handlers_[t].indexOf(i) >= 0 && this._handlers_[t].splice(this._handlers_[t].indexOf(i), 1),
                        this
                    );
                }),
            ...
            (E.prototype = new T()),
                ...
                (E.prototype.processOnMove = function (t) {
                    ...
                    if (
                        ...
                        var I = c.x - o.position.x,
                            z = c.y - o.position.y;
                        (o.frontPosition = { x: I, y: z }), i.dataOnly || (o.ui.front.style.transform = 'translate(' + I + 'px,' + z + 'px)');
                        var D = {
                ...
                (E.prototype.processOnEnd = function (t) {
                    ...
                    n &&
                        ...
                        /(semi|static)/.test(e.mode) ? i.idles.push(n) : i.nipples.indexOf(n) >= 0 && i.nipples.splice(i.nipples.indexOf(n), 1),
            ...
            (z.prototype = new T()),
                ...
                (z.prototype.getIdentifier = function (t) {
                    var i;
                    return (
                        t ? void 0 === (i = void 0 === t.identifier ? t.pointerId : t.identifier) && (i = this.latest || 0) : (i = this.index),
